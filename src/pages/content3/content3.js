      ...
      return( 
           <Layout>
              <Sider 
                ...
                <Menu
                  mode="inline"
                  defaultSelectedKeys={[Page.getPageInfo().page?Page.getPageInfo().page:'JS简介']}
                  defaultOpenKeys={Page.getPageInfo()?['sub'+Page.getPageInfo().sub]:['sub1']}
                  style={{ height: '100%', borderRight: 0 }}
                >
                  <SubMenu key="sub1" title={<span><Icon type="bars" />JS简介</span>}>
                    <Menu.Item key="JS简介" onClick={(e)=>this.handleClick(e,1)}><Link to={`${match.path}/JsBrief`}>JS简介</Link></Menu.Item>                                     
                  </SubMenu>                 
                  ...
                  <SubMenu key="sub3" title={<span><Icon type="bars" />TypeScript</span>}>
                    ...
                    <Menu.Item key="TypeScript基础" onClick={(e)=>this.handleClick(e,3)}><Link to={`${match.path}/TypeBase`}>TypeScript基础</Link></Menu.Item>               
                  </SubMenu>           
                </Menu>
              </Sider>
