			...
			<React.Fragment>
				<div className="grid-config">
					...
					<Select
						defaultValue="none"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeColumns(e)}
					>
						<Option value="none">none</Option>
						<Option value="1fr 1fr">1fr 1fr</Option>
						<Option value="2fr 1fr 2fr">2fr 1fr 2fr</Option>
						<Option value="repeat(3, [cs] 1fr [ce])">
							repeat(3, [cs] 1fr [ce])
						</Option>
						<Option value="[cs] 1fr [c2s] 1fr [c3s] 1fr [ce]">
							[cs] 1fr [c2s] 1fr [c3s] 1fr [ce]
						</Option>
					</Select>
				</div>
				<div className="grid-config">
					...
					<Select
						defaultValue="none"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeRows(e)}
					>
						<Option value="none">none</Option>
						<Option value="1fr 1fr">1fr 1fr</Option>
						<Option value="2fr 1fr 2fr">2fr 1fr 2fr</Option>
						<Option value="repeat(3, [rs] 1fr [re])">
							repeat(3, [rs] 1fr [re])
						</Option>
						<Option value="[rs r1s] 1fr [r1e r2s] 1fr [r2e re]">
							[rs r1s] 1fr [r1e r2s] 1fr [r2e re]
						</Option>
					</Select>
				</div>
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeGridRow(e)}
					>
			...
			<React.Fragment>
				<div className="grid-config">
					...
					>
						...
						<Option value="30px repeat(3, 1fr) 30px">
							30px repeat(3, 1fr) 30px
						</Option>
						<Option value="minmax(auto, 50%) 1fr 3em">
							minmax(auto, 50%) 1fr 3em
						</Option>
						<Option value="minmax(100px, auto)">minmax(100px, auto)</Option>
						<Option value="repeat(auto-fill, 50px)">
							repeat(auto-fill, 50px)
						</Option>
						<Option value="repeat(auto-fill,minmax(50px,1fr))">
							repeat(auto-fill,minmax(50px, 1fr))
						</Option>
						<Option value="repeat(auto-fit,minmax(50px,1fr))">
			...
			<React.Fragment>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="1px"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeColumnGap(e)}
					>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="1px"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeRowGap(e)}
					>
						<Option value="1px">1px</Option>
						<Option value="50px">50px</Option>
						<Option value="10%">10%</Option>
			...
			<React.Fragment>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeRowStart(e)}
					>
						<Option value="auto">auto</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeRowEnd(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="1">1</Option>
						<Option value="2">2</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeColumnStart(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="1">1</Option>
						<Option value="2">2</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeColumnEnd(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="1">1</Option>
						<Option value="2">2</Option>
			...
			<React.Fragment>
				...
				<div className="grid-config" style={{ gridColumn: 'span 2' }}>
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeGridArea(e)}
					>
						<Option value="auto">auto</Option>
			...
			<React.Fragment>
				...
				<div className="grid-config" style={{ gridColumn: 'span 2' }}>
					...
					<Select
						defaultValue="none"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeGridTemAreas(e)}
					>
						<Option value="none">none</Option>
						<Option value="&quot;header header&quot; &quot;content sidebar&quot; &quot;footer footer&quot;">
			...
			<React.Fragment>
				...
				<div className="grid-config" style={{ gridColumn: 'span 2' }}>
					...
					<Select
						defaultValue="row"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeFlow(e)}
					>
			...
			<React.Fragment>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeAutoRow(e)}
					>
						<Option value="auto">auto</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeAutoColumn(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="30px">30px</Option>
						<Option value="50px">50px</Option>
			...
			<React.Fragment>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeAlignItems(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="normal">normal</Option>
						<Option value="start">start</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeJustifySelf(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="normal">normal</Option>
						<Option value="start">start</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="auto"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeAlignSelf(e)}
					>
						<Option value="auto">auto</Option>
						<Option value="normal">normal</Option>
						<Option value="start">start</Option>
			...
			<React.Fragment>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="normal"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeJustifyContent(e)}
					>
						<Option value="normal">normal</Option>
						<Option value="start">start</Option>
						<Option value="end">end</Option>
				...
				<div className="grid-config">
					...
					<Select
						defaultValue="normal"
						style={{ width: '100%' }}
						onChange={e => this.handleChangeAlignContent(e)}
					>
						<Option value="normal">normal</Option>
						<Option value="start">start</Option>
						<Option value="end">end</Option>
